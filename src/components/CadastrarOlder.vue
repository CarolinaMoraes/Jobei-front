        ...
        <v-stepper-content step="2">
          <div class="upper-register">
            ...
            <div class="right-form">
              ...
              <b-row>
                <b-col sm="6">
                  <b-form-group label="Nome:" :label-cols="2" horizontal label-text-align="center">
                    <input
                      type="text"
              ...
              <b-row>
                <b-col sm="6">
                  <b-form-group label="CEP:" :label-cols="2" horizontal label-text-align="center">
                    <masked-input
                      maxlength="9"
                      mask="11111 - 111"
                      placeholder="CEP"
                ...
                <b-col>
                  <b-btn class="btn btn-outline-info mt-4" @click="fetchCep">buscar</b-btn>
                </b-col>
              </b-row>
